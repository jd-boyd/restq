...
* Commands (AKA API):
<strong>PUT <em>queueName</em></strong>
...
<strong>POST <em>queueName</em></strong>
...
<strong>GET msg/<em>queueName</em></strong>
...
<strong>GET queues</strong>

Get a list of the created queues.

200

<strong>DELETE <em>queueName</em>/<em>integer</em></strong>
...
<strong>DELETE <em>queueName</em></strong>
